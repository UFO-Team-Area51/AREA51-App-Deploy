...
layout = dbc.Container([
    ...
    html.Div(children=[
        ...
        html.Br(),
        dbc.Col(
            html.Hr(style={"borderWidth": "0.5vh", "width": "117%", "borderColor": "#00c3ff", "opacity": "unset", }
                    ),
            width={"size": 10, "offset": 0},
        ),

        # MBM report Graph/Chart
        html.Details([

            html.Summary('Click me to expand/collapse MBM Case Report',
                         style={'color': '#00d257', 'textAlign': 'center',
                                'font-size': '120%'}),
            ...
            # MBM Download
            html.Center(
                dcc.Dropdown(name_list, first_name_list, id='download_mbm_dropdown', clearable=False,
            ...
            html.Br(),
            html.Center(
                dbc.Button("Download MBM Excel", style={"width": "30%"}, color="success", outline=True,
                           id='download_mbm_btn', n_clicks=0,
                           ),
            ),
        ...
        # UET report Graph/Chart
        html.Details([

            html.Summary('Click me to expand/collapse UET TIcket Report',
                         style={'color': '#00d257', 'textAlign': 'center', 'font-size': '120%'}
                         ),
            ...
            html.Center(
                dcc.Dropdown(name_list, first_name_list, id='download_uet_dropdown', clearable=False,
                             className="text-success", style={'textAlign': 'center',
                                                              'width': '55%',
                                                              'left': '10%',
                                                              'transform': 'translateX(8%)',
            ...
            html.Br(),
            html.Center(
                dbc.Button("Download UET Excel", style={"width": "30%"}, color="success", outline=True,
                           id='download_uet_btn', n_clicks=0),
            ),
